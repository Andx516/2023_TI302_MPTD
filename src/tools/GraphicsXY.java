...
public class GraphicsXY extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnDraw, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 40, -1, -1));
    ...
    private void drawAxis() {
        ...
        g.drawLine(Coordinate.toScreenX(Coordinate.XMIN),
                Coordinate.toScreenY(0),
                Coordinate.toScreenX(Coordinate.XMAX),
                Coordinate.toScreenY(0));
        //draw Y Axis (0,YMIN) (0, YMAX)
        g.drawLine(Coordinate.toScreenX(0), Coordinate.toScreenY(Coordinate.YMIN), Coordinate.toScreenX(0), Coordinate.toScreenY(Coordinate.YMAX));
    
    //X Ticks
    for(float dx = Coordinate.XMIN;dx <= Coordinate.XMAX; dx += 1.0f){
    g.drawLine(Coordinate.toScreenX(dx),
    ...
    g.drawLine(Coordinate.toScreenX(-0.25f),
